...
export default function NavBar() {
    ...
    return (
        <div>
                                            ...
                                            {navigation.map((item) => (
                                                <Link
                                                    ...
                                                    onClick={(e) => {
                                                        ...
                                                        Array.from(e.target.parentNode.querySelectorAll(":scope>a")).forEach(element => {
                                                            console.log(element.textContent)
                                                            element.className = item.name === element.textContent ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white'
                                                            element.className += ' px-3 py-2 rounded-md text-sm font-medium'
                                                        });
                                                    }}
                                                >
                                                    {item.name}
            ...
            <div className='flex justify-between items-center px-20 container'>
